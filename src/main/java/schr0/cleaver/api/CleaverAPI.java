...
public class CleaverAPI
{
	 ...
	 */
	@Cancelable
	public static class ItemCleaverDropsEvent extends Event
	{
		...
		public ItemCleaverDropsEvent(ArrayList<ItemStack> drops, EnumRarity rarity, ItemStack stack, EntityLivingBase target, EntityLivingBase attacker)
		{
			this.drops = drops;
			this.rarity = rarity;
			this.stack = stack;
